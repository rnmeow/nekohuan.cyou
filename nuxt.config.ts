export default {
  ...
  app: {
    head: {
      ...
      script: [
        { src: '//unpkg.com/twikoo@1.6.8/dist/twikoo.all.min.js', type: 'text/javascript' },
        // { src: '//cdn.staticfile.org/twikoo/1.6.8/twikoo.all.min.js', type: 'text/javascript' }, -> 在中國速度較快
